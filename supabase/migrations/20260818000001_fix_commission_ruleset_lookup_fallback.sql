-- Fix: Add graceful multi-tier fallback when looking up commission rule set in calculate_deal_commission.
-- Tier 1: Default rule set covering the registration date.
-- Tier 2: Any active rule set covering the registration date.
-- Tier 3: Any default rule set for the agency.
-- Tier 4: Most recent rule set for the agency.

create or replace function public.calculate_deal_commission(p_deal_id uuid, p_rule_set_id uuid default null)
returns uuid
