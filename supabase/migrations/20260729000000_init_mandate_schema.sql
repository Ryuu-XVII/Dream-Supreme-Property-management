...
do $$ begin create policy "Anyone can insert a lead from public calculators" on public.lead for insert with check (agency_id is not null and full_name is not null); exception when duplicate_object then null; end $$;
