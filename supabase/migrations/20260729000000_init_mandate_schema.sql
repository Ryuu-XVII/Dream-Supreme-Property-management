...
do $$ begin create policy "Anyone can insert a lead from public calculators" on public.lead for insert with check (true); exception when duplicate_object then null; end $$;
