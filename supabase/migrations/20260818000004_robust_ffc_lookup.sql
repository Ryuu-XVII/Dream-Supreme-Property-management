-- Fix: Comprehensive multi-path FFC verification in calculate_deal_commission.
-- Supports user_account_id, email/name correlation, ffc_certificate table, document table, and PPRA reference.
