          ...
          {editing && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Configure general settings, deduction waterfall and office share. Preview updates
                  live.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.3fr_1fr]">
                <div className="space-y-6 min-w-0">
                  ...
                  <section className="space-y-3 rounded-lg border border-border p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        className="gap-1"
                        onClick={() =>
                          setEditing({ ...editing, deductions: [...editing.deductions, newLine()] })
                        }
                      >
                              ...
                              <div className="flex items-center gap-1 justify-end">
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    setEditing({
                                      ...editing,
                                      deductions: editing.deductions.filter((_, i2) => i2 !== idx),
                                    });
                                  }}
                                >
                  ...
                  <section className="space-y-3 rounded-lg border border-border p-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Agent pool receives {100 - editing.officeSharePct}% of the distributable pool.
                    </p>
                  </section>
                </div>
